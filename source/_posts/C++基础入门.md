...
toc_style_simple:
copyright:
copyright_author: 黑马程序员
copyright_author_href: https://www.itheima.com/
copyright_url: https://www.itheima.com/
copyright_info: 本博文转载自 黑马程序员 的开源资料，如有侵权，系删！
mathjax:
katex:
aplayer:
highlight_shrink:
...
### 本博文转载自 黑马程序员 的开源资料，只是为了方便自己学习，并非盗用他人成果！
...
有三只小猪 ABC，请分别输入三只小猪的体重，并且判断哪只小猪最重？![三只小猪](assets/三只小猪.jpg)
